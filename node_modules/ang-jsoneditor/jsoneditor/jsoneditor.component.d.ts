...
export declare class JsonEditorComponent implements ControlValueAccessor, OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<JsonEditorComponent, "json-editor", never, { "options": "options"; "debug": "debug"; "data": "data"; }, { "change": "change"; "jsonChange": "jsonChange"; }, never, never, false, never>;
}
